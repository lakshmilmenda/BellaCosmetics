...
<c:url value="/addSup" var="sup"/>
 <form:form action="${sup}" method="post"  modelAttribute="supplier"  name="myform" onsubmit ="return validate()"> 
  <h2>Supplier Form</h2>
<h6>Supplier Id:</h6>
 <form:input type="text" class="text"  name="Id" path="supId" />
<h6>Supplier Name:</h6>
 <form:input type="text"  class="text" id="name" name="name" path="supName"/>
 <h6>Supplier Address:</h6>
 <form:input type="text" class="text"  id="add" name="add" path="supAdd"/>
<h6>Supplier Phone Number:</h6>
 <form:input type="text" class="text"  id="phno" name="phno" path="supPhoneNo"/>
 ...
 function valNum()
 {    	
     var fphoneno = document.myform.phno.value;
     var nums=/^[0-9]+$/;
 ...
 function validate()
 {
 	...
 	var fname = document.myform.name.value;
     var faddress = document.myform.add.value;
     var fphoneno = document.myform.phno.value;
