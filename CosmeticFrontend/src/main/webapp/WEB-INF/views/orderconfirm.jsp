...
<h2>Shipping</h2>
		<h6>Shipping Id:</h6>
     <input type="text" class="text" name="id"  value="${shipping.getShipId()}" />
   	<h6>Shipping Name:</h6>
    <input type="text" class="text" name="name" value="${shipping.getShipName()}" />
    <h6>Shipping City:</h6>
     <input type="text" class="text" name="city"  value="${shipping.getShipCity()}"/>
      <h6>Shipping State:</h6>
      <input type="text" class="text" name="state" value="${shipping.getShipState()}" />
      <h6>Shipping Phone Number:</h6>
       <input type="text" class="text" name="phoneno"  value="${shipping.getShipPhoneNo()}"/>
...
<div class="container">
  ...
  <tr>
  <td>
  <img  src="<c:url value="/resources/images/${pro.getProId()}.jpg"/>" style="width:100px; height:100px"/>
  </td>
  <td>
  ${pro.getProName()}</td>
  ...
  <tr>
  <td  colspan="4" style="font-size:20px;font-weight:600;">Total:   ${pro.getProPrice()}</td>
  </tr>
  ...
  <tr >
  <td>
  <img  src="<c:url value="/resources/images/${pro.getProduct().getProId()}.jpg"/>" style="width:100px; height:100px"/>
  </td>
  <td>
  ${pro.getProduct().getProName()}</td>
  <td>${pro.getProduct().getProPrice()}</td>
  <td style = " background-color:rgba(255,255,255,0.3)">${pro.getProduct().getProDes()}</td>
  </tr>
  
  </c1:forEach>
   <tr>
  <td  colspan="4" style="font-size:20px;font-weight:600;">Total = ${cart.getGrandTotal()}</td></tr>
  ...
  <br>
  <center>
<c:url value="/pay" var="pay"/>
<a href="${pay}" id="button" >Continue</a>
<c:url value="/" var="home"/>
<a href="${home}" id="button" >Cancel</a>
</center>
</div>
<br>
<br>
