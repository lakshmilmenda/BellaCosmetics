...
<c1:if test="${pageContext.request.userPrincipal.name!=null}">
<h4 id = "user">Welcome   &nbsp<span  style="font-size:25px;font-family: 'Niconne', cursive;">${pageContext.request.userPrincipal.name}</span>     
</h4></c1:if>
...
<div id="logo">
   	...
   	<h4>Staying  In Style Forever</h4>
</div>	


<div class="container-fuild"id="description">
		<div id="leftdes"><img src="${img}/wow1.jpg"></div>
		<p>Every woman is already beautiful, and every woman can be even more beautiful!! When a woman improves her appearance, an amazing thing happens. We have always been, and probably always will be a make-up junkie.</p><p> Our heart yearns for the high end, and raved about products. Unfortunately for us, our wallet cannot support these desires. So, if you're looking for a way to keep your make-up game on 'fleek,' but you're on a college girl budget -- check out these amazing dupes of products</p>
...
<c1:forEach items="${Brands}" var="brand">
          ...
          <a href="<c:url value="/display/${brand.getBrandId()}"/>"style="color:#4c0033 " target="_self">  <img  src="<c:url value="/resources/images/${brand.getBrandName()}.jpg"/>"/></a>
        </c1:forEach>
...
<h3 >Categories</h3>
 ...
 <c1:forEach items="${Catgeories}" var="cat">
          ...
          <a  href="<c:url value="/displayProduct/${cat.getCatId()}"/>" style="color:#4c0033 " target="_self">   <img  class="hvr-bounce-in" src="<c:url value="/resources/images/${cat.getCatName()}.jpg"/>"/></a>
...
<h3 >Best Sellers</h3>
 ...
 <c1:forEach items="${Products}" var="pro" begin="0" end="2">

          <a  href="<c:url value="/AllProducts"/>" style="color:#4c0033 " target="_self">   <img  class="hvr-push" src="<c:url value="/resources/images/${pro.getProId()}.jpg"/>"/></a>
...
<h3 >Bella Pick's</h3>
 ...
 <c1:forEach items="${Products}" var="pro" begin="5" end="7">

          <a  href="<c:url value="AllProducts"/>" style="color:#4c0033 " target="_self">   <img  class="hvr-bounce-in" src="<c:url value="/resources/images/${pro.getProId()}.jpg"/>"/></a>
