...
<div class="container">
 ...
 <c1:forEach items="${cartItem}" var="car">
  <tr>
 <td><img  style="width:100px;height:100px;border-radius:5px;" src="<c:url value="/resources/images/${car.getProduct().getProId()}.jpg"/>"/></td>
 <td>${car.getProduct().getProId()}</td>
  <td>${car.getProduct().getProName()}</td>
  <td>${car.getProduct().getProPrice()}</td>
	
     <td>
     <c:url value="/Buy/${car.getProduct().getProId()}/${car.getCartItemsId()}" var="cart"/>
<a href="${cart}" id="button">Buy</a><br><br>
<c:url value="/Remove/${car.getCartItemsId()}" var="cart"/>
<a href="${cart}" id="button">Remove</a>

</td>   </tr>
 </c1:forEach>
<tr>
<td colspan="5" style="text-align:center; font-size:23px;font-weight:600;"> Grand Total : &nbsp ${grandtotal}</td>
</tr>
   <tr>
  <td colspan="5" style="text-align:center;padding:15px;">
  <c:url value="/Buyall" var="cart"/>
<a href="${cart}" id="button">Buy All </a>&nbsp
<c:url value="/RemoveAll" var="cart"/>
<a href="${cart}" id="button">Remove All</a></td>
   </tr>
 </table>
