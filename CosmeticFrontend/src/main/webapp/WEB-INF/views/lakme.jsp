...
<br>
  ...
  <div class="container-fuild" id="main"  style="padding-bottom:20px;">
  <img src="<c:url value="/resources/images/${brand.getBrandId()}.jpg"/>" id="mainimg"/>

 <c1:forEach items="${Products}" var="pro">
  <div class="container" id="cat" style="clear:both">
  <img  src="<c:url value="/resources/images/${pro.getProId()}.jpg"/>"/>
</div>
<div id="catdes">
  <h3>${pro.getProName()}</h3>
 <p>Price: Rs. ${pro.getProPrice()}</p>
 <ul style="margin-bottom:30px ; ">
  <li>${pro.getProDes()}</li>
 </ul>
<c:url value="/addtocart/${pro.getProId()}" var="cart"/>
<a href="${cart}" id="button" >Add To Cart</a>
