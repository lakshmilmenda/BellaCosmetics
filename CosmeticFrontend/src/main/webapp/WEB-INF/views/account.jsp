...
<c:url value="/j_spring_security_check" var="account"/>
  <form:form action="${account}" method="post">
   
    <input type="text" class="text" name="j_name" placeholder="Email-Id" ><br>
    <input type="password" id="password" name="j_password" placeholder="Password" required><br>
    <input type="submit"  id="submit" value="Submit"><br>
     <input type="reset"  id="cancel" value="Cancel">
  </form:form>

</div>
<h5>Do not have an Account??? <a href= " <c:url value="/user"/>">Click here</a></h5>
