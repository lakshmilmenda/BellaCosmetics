...
<c:url value="/addCat" var="cat"/>
 <form:form action="${cat}" method="post"  modelAttribute="category" name="myform" onsubmit ="return validate()" enctype="multipart/form-data">
 <h2>Category Form</h2>
 <h6>Category Image</h6>
 <form:input class="text" type="file"  value="uploadfile" path="cimg" />
 <h6>Category Logo</h6>
 <form:input class="text" type="file"  value="uploadfile" path="clogo" />
  <h6>Category Id:</h6> 
 <form:input type="text" class="text" name="Id" path="catId" />
<h6>Category Name:</h6>
 <form:input type="text" class="text" id="name" name="name" onchange="return valName()" path="catName" />
 ...
 <tr>
  <td><img  style="width:70px;height:70px" src="<c:url value="/resources/images/${cat.getCatId()}.jpg"/>"/></td>
    <td><img  style="width:70px;height:70px" src="<c:url value="/resources/images/${cat.getCatName()}.jpg"/>"/></td>
 <td>${cat.getCatId()}</td>
